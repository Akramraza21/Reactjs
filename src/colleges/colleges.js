        ...
        <div key={index} className={classes.container}>
          ...
          <div className={classes.collegeName}>
            <div className={classes.fee}>
              ...
              <div className={classes.originalFee}>₹{param.original_fees}</div>
              <div>
                <small className={classes.smallSize}>{param.fees_cycle}</small>
              </div>
            ...
            <div className={classes.offer}>
              Flat Rs<span className={classes.offColor}>2,000</span> off + upto
              Rs <span className={classes.offColor}>500</span> wallet! to
              avail...
